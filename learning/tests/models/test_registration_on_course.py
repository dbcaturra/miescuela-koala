...
from learning.models import Activity, Course, CourseCollaborator, CollaboratorRole, RegistrationOnCourse
...
class CourseCollaboratorTest(TestCase):
    ...
    def test_clean_registration_on_course_also_author(self):
        roc = RegistrationOnCourse.objects.create(
            course=self.public_course,
            student=self.public_course.author,
        )
